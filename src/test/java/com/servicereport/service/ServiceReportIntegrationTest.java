...
@SpringBootTest
@Transactional
class ServiceReportIntegrationTest {
	...
	@Test
	@DisplayName("查詢所有服務檢舉")
	void findAll_shouldReturnRealData() {

	    List<ServiceReportVO> serviceReportList = serviceReportRepository.findAll();

	    assertNotNull(serviceReportList);

	    System.out.println("查到 " + serviceReportList.size() + " 筆服務檢舉");
